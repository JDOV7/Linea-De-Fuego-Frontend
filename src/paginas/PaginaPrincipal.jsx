  ...
  return (
    <>
        ...
        <nav className="bg-white border-gray-200 py-2.5 dark:bg-principal">
          <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
            ...
            <div className="flex items-center lg:order-2">
              {/* <a
                href="#"
                className="text-cuarto bg-secundario hover:bg-principal focus:ring-4 focus:ring-secundario font-medium rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-secundario dark:hover:bg-secundario focus:outline-none dark:focus:ring-secundario"
              >
                Crear Cuenta
              </a> */}
              <Link
                to="/crear-cuenta"
                className="text-cuarto bg-secundario hover:bg-principal focus:ring-4 focus:ring-principal font-medium rounded-lg text-base px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:hover:bg-principal focus:outline-none dark:focus:ring-principal
      ...
      {/* <div
        ...
        style="background-image: url('/src/assets/blob-scene-haikei.svg');"
      >
        <img src={blobScene} alt="Imagen" className="w-full h-auto" />
        <div className="absolute top-0 left-0 p-4">
          <h1 className="text-white text-3xl font-bold">
            Contenido encima de la imagen
          </h1>
          <p className="text-white text-lg mt-2">Descripción del contenido</p>
        </div>
      </div> */}
      {/* <body
        class="bg-cover bg-center"
      ...
      <section className=" dark:bg-cuarto ">
        <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-10 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-principal">
              Compra Tus Libros, Mangas y Comics Favoritos{" "}
              <span className="text-secundario font-black"> Aqui!</span>
            </h1>

            <p className="max-w-2xl mb-6  text-black font-normal lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Descubre la mejor selección de libros, cómics y mangas en nuestra
              tienda en línea. Con una amplia variedad de títulos y géneros asi
              como precios competitivos, estamos seguros de que encontrarás lo
              que buscas en nuestra tienda.¡Compra con confianza y descubre por
              qué somos la mejor opción para los amantes de la lectura!
            </p>

            <div className=" sm:space-x-4">
              {/* <button className=" text-cuarto bg-secundario hover:bg-principal focus:ring-4 focus:ring-secundario font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-secundario dark:hover:bg-secundario focus:outline-none dark:focus:ring-secundario">
                Ingresar
              </button> */}
              <Link
                to="/login"
      ...
      <section className="bg-white dark:bg-cuarto">
